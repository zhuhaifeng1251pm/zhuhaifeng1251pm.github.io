var addressInit = function(_cmbProvince, _cmbCity, _cmbArea, defaultProvince, defaultCity, defaultArea)
{
	...
	function changeCity()
	{
		...
		// console.log(cmbCity.selectedIndex);
		
		var item = cmbCity.options[cmbCity.selectedIndex].obj;//拿到市的名字
		// cmbCity.innerText =item
	...
	function changeProvince()
	{
		...
		var item = cmbProvince.options[cmbProvince.selectedIndex].obj;//拿到省的名字
		// cmbProvince.innerText =item
		for(var i=0; i<item.cityList.length; i++)
		{
			cmbAddOption(cmbCity, item.cityList[i].name, item.cityList[i]);
			
			// console.log(item.cityList[i].name);
			// console.log(item.cityList[i]);
			// console.log(cmbCity);
		}
	// console.log(cmbCity);
