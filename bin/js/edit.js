for (var i = 0; i < document.querySelectorAll(".edit").length; i++) {
  document.querySelectorAll(".edit")[i].onclick = function(ev) {
    var oEvent = ev || event;
    ...
    var peoplee = this.parentNode.parentNode.querySelector(".people-name")
      .innerText;
    var tellphonee = this.parentNode.parentNode.querySelector(".tellphone")
      .innerText;
